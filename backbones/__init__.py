...
openclip_models = [
    ...
    "openclip_vit_g14",
    "openclip_vit_G14",
    "openclip_convnext_base_w",
    "openclip_convnext_large_d",
    "metaclip_vit_b32",
    "metaclip_vit_b16",
    "metaclip_vit_l14",
    "metaclip_vit_h14",
...
model_dict = {
    ...
    "openclip_convnext_base_w": [
        640,
        "head",
        [f"trunk.stages.{i}" for i in range(4)],
        [f"text_encoder.transformer.resblocks.{i}" for i in range(12)],
        None,
    ],
    "openclip_convnext_large_d": [
        ...
        "head",
        [f"trunk.stages.{i}" for i in range(4)],
        [f"text_encoder.transformer.resblocks.{i}" for i in range(16)],
        None,
    ],
    "metaclip_vit_b32": [
        512,
...
openclip_conv = {
    ...
    "openclip_convnext_base_w": ["convnext_base_w", "laion2b_s13b_b82k_augreg"],
    "openclip_convnext_large_d": ["convnext_large_d", "laion2B_s26B_b102K_augreg"],
